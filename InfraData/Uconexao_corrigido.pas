...
begin
  inherited Create;  // Chamar inherited primeiro
  IniciarConexao;    // Criar os objetos
  CarregarIni;       // Carregar configurações
end;

destructor Tconecxao.Destroy;
begin
...
begin
  // Criar os objetos ANTES de acessá-los
...
begin
  try
    ...
    on E: Exception do
    begin
      MessageDlg('Conexão do banco de dados falhou! ' + E.Message, 
